$(document).ready(function () {
    ...
    $('.j--section-features').waypoint(function (direction) {
        /*if the user scrolls down the sticky nav should appear and when they scrol up it should disapear*/
        if (direction == "down") {
            $('nav').addClass('sticky');
        } else {
    ...
    /*Scroll to section plans using the 'I'm hungry' button*/
    ...
    $('.js--scroll-to-section-features').click(function () {
        $('html,body').animate({
            scrollTop: $('.j--section-features').offset().top
        }, 1000);

    });


    /*Scrolling animation for clicking on the navaition buttons*/
